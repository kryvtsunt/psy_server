...
(function(){
    ...
    angular
        ...
        .constant("serverURL", { url : 'http://testpsych-env.6mijsua8pr.us-east-2.elasticbeanstalk.com/'})
        
        //this is the backup 
        //.constant("serverURL", { url : 'http://testpsych-env-1.6mijsua8pr.us-east-2.elasticbeanstalk.com//'})        
        //.constant("serverURL", { url : 'http://testpsych-env.6mijsua8pr.us-east-2.elasticbeanstalk.com/'})
        //.constant("serverURL", { url : 'http://localhost:8080/'})
        //.constant("serverURL", { url : 'http://localhost:8080/Psych/'})
