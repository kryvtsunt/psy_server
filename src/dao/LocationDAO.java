...
public class LocationDAO {
	...
	public static boolean createLocation(Location location){
		...
		/*
		 * String insertQuery =
		 * "INSERT INTO LOCATION (location.locCode, location.locName, location.description, location.keywords, "
		 * +
		...
		String insertQuery = "INSERT INTO LOCATION (locCode, locName, description, keywords, "
				+ "addressLine1, addressLine2,  city, state, zipcode, phoneNumber, "
				+ "faxNumber, email) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public static boolean updateLocation(Location location){
		...
		String updateQuery = "UPDATE LOCATION SET locCode=?, locName=?, description=?, keywords=?, "
				+ "addressLine1=?, addressLine2=?,  city=?, state=?, zipcode=?, phoneNumber=?, "
				+ "faxNumber=?, email=? WHERE id = ?";
