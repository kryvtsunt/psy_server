...
public class TrainingDAO {
	...
	public static JSONArray getQuestionsForTrainingById(Long trainingId){
		...
		String selectQuery = "SELECT A.ID AS tId, C.ID AS qId, C.NAME AS qName, "
				...
				+ "FROM TRAINING AS A "
				+ "INNER JOIN TRAININGQUESTIONMAP AS B ON A.ID = B.TRAININGID "
				+ "INNER JOIN QUESTION C ON B.QUESTIONID = C.ID "
				+ "INNER JOIN QUESTIONCATEGORY AS D ON D.ID = C.CATEGORYID "
				+ "WHERE A.ID = ?;";
	...
	public static JSONArray getImagesForTrainingById(Long trainingId){
		...
		String selectQuery = "SELECT A.ID AS tId, C.ID AS imageCategoryId, "
				...
				+ "FROM TRAINING AS A "
				+ "INNER JOIN TRAININGIMAGEMAP AS B ON A.ID = B.TRAININGID "
				+ "INNER JOIN IMAGECATEGORY AS C ON B.IMAGECATEGORYID = C.ID "
				+ "INNER JOIN FIELDLOOKUP AS D ON B.IMAGETYPE = D.ID "
